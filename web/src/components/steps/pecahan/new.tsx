...
export default function BiodataStep({
  ...
  const { dataA, dataB, setDataB, dataC, setDataC, dataD, setDataD, dataE, setDataE, dataF, setDataF, loading, error, inputData } = useBiodata(user!);
                ...
                <div className="flex flex-col md:flex-row gap-4">
                  ...
                  <div className="flex flex-col w-full md:w-1/2">
                    ...
                    <input
                      ...
                      onChange={(e) => setFormData({ ...dataE, no_telp_wali: e.target.value })}
                      className ={`border rounded-lg px-3 py-2 ${
                        isEditing
                          ? "bg-white text-gray-700"
                          : "bg-gray-100 text-gray-500 cursor-not-allowed"
